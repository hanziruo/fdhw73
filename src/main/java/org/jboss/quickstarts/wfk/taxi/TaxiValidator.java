...
public class TaxiValidator {
     ...
     *
     *
     * <p>If the error is caused because an existing taxi with the same registration name is registered it throws a regular validation
     * exception so that it can be interpreted separately.</p>
     *
     * 
     * @param taxi The Taxi object to be validated
     * @throws ConstraintViolationException If Bean Validation errors exist
     * @throws ValidationException If taxi with the same registration name already exists
     */
    void validateTaxi(Taxi taxi) throws ConstraintViolationException, ValidationException {
        ...
        // Check the uniqueness of the registration name
    ...
    /**
     * <p>Checks if a taxi with the same registration name is already registered. This is the only way to easily capture the
